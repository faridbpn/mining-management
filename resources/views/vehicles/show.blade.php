...
<div class="flex items-center justify-center min-h-[80vh] bg-gray-100">
    <div class="w-full max-w-lg bg-white rounded-xl shadow-lg p-8">
        ...
        <div class="space-y-4">
            ...
            <div class="flex justify-between items-center">
                <span class="font-semibold">Kepemilikan:</span>
        ...
        <div class="mt-8 flex gap-2">
            <a href="{{ route('admin.vehicles.edit', $vehicle) }}" class="bg-yellow-400 hover:bg-yellow-500 text-gray-900 px-4 py-2 rounded font-semibold">Edit</a>
            <a href="{{ route('admin.vehicles.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 px-4 py-2 rounded font-semibold">Kembali</a>
        </div>
    </div>
</div>
@endsection 